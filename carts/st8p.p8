	...
	return {
		...
		draw=function()
			...
			if plyr then
				...
				-- ♥
				local s=""
				local hp,coins=plyr:score()
				for i=1,hp do
					s=s.."♥"
				end
				printb(s,2,4,7,5,1)

				printb("●"..coins,2,13,7,5,1)
...
function make_ground(params)
	...
	local function make_slice(y)
		...
		for i=0,nx-1 do
			...
			-- tree
			actors[i]=rnd()>0.6 and {sx=112,sy=16,r=1.2}
		end
...

