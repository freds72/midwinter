		...
		steer=function(self,steering_dt)
			...
			if self.on_ground==true and v_len(velocity)>0.001 then
				...
				if abs(sa)>0.001 then
					...
					self:apply_force_and_torque(right,-steering_angle*ski_len/8)				
				end
...
function draw_sprite(actor,x,y,w,dist)
	...
	w=actor.w or w
	sspr(actor.sx,actor.sy,actor.w or 16,actor.w or 16,x-w/2,actor.y or y-w,w,w)
	pal()
end
...
function make_ground(delta_slope)
	...
	local function make_slice(y)
		...
		for i=0,nx-1 do
			...
			-- tree
			actors[i]=rnd()>0.6 and {sx=112,sy=16,r=0.8}
		end
...
function make_rspr(sx,sy,n,tc)
	...
	for i=0,n-1 do
		...
		for iy=0,15 do
			...
			for ix=0,15 do
				if band(bor(srcx,srcy),0xffe0)==0 then
...

...

...

