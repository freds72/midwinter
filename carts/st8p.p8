...
function draw_drawables(objects)	
	for i=1,#objects do
		...
		if d.a then
			-- sprite
			local w=d.w
			sspr(d.a.sx,d.a.sy,16,16,d.x-w/2,d.y-w,w,w)
		else
			-- triangle
			local c0=0x76
			if d.f.n[2]<0.6 then
			...
			if d.f.actor then
				local m,v0,u,v=cam.m,d.v0,d.f.actor.u
				...
				if az>z_near and az<64 then	
					...
					sspr(d.f.actor.sx,d.f.actor.sy,16,16,x-w/2,y-w,w,w)
					pal()
				end
			end
		end
...
function make_ground(model)
	...
	local function mesh(j)
		...
		for i=0,nx-2 do
			...
			v_add(u,u3,0.5-t)
			if rnd()>0.95 then
				f[fi].actor={u=u,sx=48,sy=0}
			elseif rnd()>0.9 then
				f[fi].actor={u=u,sx=112,sy=16}
			elseif rnd()>0.85 then
				f[fi].actor={u=u,sx=112,sy=0}
			end
			fi+=2
		end
	...
	local function collect_face(face,vertices,v_cache,cam_pos,out,dist)
		...
		if v_dot(face.n,cam_pos)>v_dot(face.n,v0) then
			...
			if outcode==0 then
				...
				-- still visible?
				if #verts>2 then
					out[#out+1]={key=1/z,f=face,v=verts,dist=dist,v0=v0}
				end
			end
		elseif face.actor then
			local m,u=v_cache.m,face.actor.u
			local x,y,z=v0[1]+u[1],v0[2]+u[2],v0[3]+u[3]
			local az=m[3]*x+m[7]*y+m[11]*z+m[15]
			if az>z_near and az<64 then	
				local ax,ay=m[1]*x+m[5]*y+m[9]*z+m[13],m[2]*x+m[6]*y+m[10]*z+m[14]
				out[#out+1]={key=1/z,a=face.actor,x=63.5+flr(shl(ax/az,6)),y=63.5-flr(shl(ay/az,6)),w=shl(4/az,6),dist=dist}
			end
		end
	end
...
__gfx__

